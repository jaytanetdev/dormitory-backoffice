...
export const config={matcher:["/dashboard/:path*","/stores/:path*","/rooms/:path*","/residents/:path*","/bills/:path*","/calendar/:path*","/payments/:path*","/users/:path*","/roles/:path*","/settings/:path*"]};
