...
export interface PaymentDto { id:string;amount:number|string;createdAt:string;status:string;invoice:{room:{number:string};contract:{resident:{fullName:string}}};slip:{fileUrl:string;fileName?:string|null;mimeType?:string|null}|null }
